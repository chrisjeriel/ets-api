...
public class CLMR010O {
	...
	public String toString() {
		return "CLMR010O [extractUser=" + extractUser + ", extractDate=" + extractDate + ", currencyCd=" + currencyCd
				...
				+ histCatDesc + ", insuredClm=" + insuredClm + ", insuredDesc=" + insuredDesc + ", approvedAmt="
				+ approvedAmt + ", lossResAmt=" + lossResAmt + ", adjId=" + adjId + ", adjName=" + adjName
