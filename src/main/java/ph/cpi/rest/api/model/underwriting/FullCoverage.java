...
public class FullCoverage {
	...
	private List<FullSecCover> fullSecCover;
	...
	public List<FullSecCover> getFullSecCover() {
		return fullSecCover;
	}

	public void setFullSecCover(List<FullSecCover> fullSecCover) {
		this.fullSecCover = fullSecCover;
	}

	@Override
	public String toString() {
		return "FullCoverage [treatyShare=" + treatyShare + ", sectionISi=" + sectionISi + ", sectionIISi="
				+ sectionIISi + ", sectionIIISi=" + sectionIIISi + ", totalSi=" + totalSi + ", sectionIPrem="
				+ sectionIPrem + ", sectionIIPrem=" + sectionIIPrem + ", sectionIIIPrem=" + sectionIIIPrem
				+ ", totalPrem=" + totalPrem + ", currencyCd=" + currencyCd + ", currencyRt=" + currencyRt
				+ ", pctShare=" + pctShare + ", pctPml=" + pctPml + ", totalValue=" + totalValue + ", remarks="
				+ remarks + ", cumSecISi=" + cumSecISi + ", cumSecIISi=" + cumSecIISi + ", cumSecIIISi=" + cumSecIIISi
