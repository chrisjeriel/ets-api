...
public class SaveMtnAcseDefAcctEntRequest {
	private List<acseDefAcctEnt> saveAcctEnt;
	private List<acseDefAcctEnt> delAcctEnt;
	public List<acseDefAcctEnt> getSaveAcctEnt() {
		return saveAcctEnt;
	}
	public void setSaveAcctEnt(List<acseDefAcctEnt> saveAcctEnt) {
		this.saveAcctEnt = saveAcctEnt;
	}
	public List<acseDefAcctEnt> getDelAcctEnt() {
		return delAcctEnt;
	}
	public void setDelAcctEnt(List<acseDefAcctEnt> delAcctEnt) {
		this.delAcctEnt = delAcctEnt;
	}
	@Override
	public String toString() {
		return "SaveMtnAcseDefAcctEntRequest [saveAcctEnt=" + saveAcctEnt + ", delAcctEnt=" + delAcctEnt + "]";
	}
	
}

class acseDefAcctEnt{
	...
	@Override
	public String toString() {
		return "acseDefAcctEnt [tranClass=" + tranClass + ", tranTypeCd=" + tranTypeCd + ", entryNo=" + entryNo
