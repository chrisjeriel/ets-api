...
public class SaveAcseJVEntryRequest {
	...
	public String toString() {
		return "SaveAcseJVEntryRequest [tranId=" + tranId + ", tranDate=" + tranDate + ", tranClass=" + tranClass
				...
				+ ", jvDate=" + jvDate + ", jvStatus=" + jvStatus + ", jvTranTypeCd=" + jvTranTypeCd + ", autoTag="
				+ autoTag + ", refnoTranId=" + refnoTranId + ", refnoDate=" + refnoDate + ", particulars=" + particulars
				+ ", currCd=" + currCd + ", currRate=" + currRate + ", jvAmt=" + jvAmt + ", localAmt=" + localAmt
