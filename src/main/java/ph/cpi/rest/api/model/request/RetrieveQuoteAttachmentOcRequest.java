...
public class RetrieveQuoteAttachmentOcRequest {
	...
	public String toString() {
		return "RetrieveQuoteAttachmentOcRequest [quoteIdOc=" + quoteIdOc + ", openQuotationNo=" + openQuotationNo + ", paginationRequest="
