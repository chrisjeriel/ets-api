...
public class MultiOffsetInvPo {
	...
	public String toString() {
		return "MultiOffsetInvPo [tranId=" + tranId + ", invtId=" + invtId + ", invtCode=" + invtCode + ", certNo="
				+ certNo + ", invtType=" + invtType + ", invtTypeDesc=" + invtTypeDesc + ", invtSecCd=" + invtSecCd
				+ ", securityDesc=" + securityDesc + ", maturityPeriod=" + maturityPeriod + ", durationUnit="
				+ durationUnit + ", interestRate=" + interestRate + ", purchasedDate=" + purchasedDate
				+ ", maturityDate=" + maturityDate + ", pulloutType=" + pulloutType + ", currCd=" + currCd
