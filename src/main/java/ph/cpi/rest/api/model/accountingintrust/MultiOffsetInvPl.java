...
public class MultiOffsetInvPl {
	...
	public String toString() {
		return "MultiOffsetInvPl [tranId=" + tranId + ", invtId=" + invtId + ", currCd=" + currCd + ", currRate="
				...
				+ ", purchasedDate=" + purchasedDate + ", maturityDate=" + maturityDate + ", incomeAmt=" + incomeAmt
