...
public class Quotation {
	...
	public String toString() {
		return "Quotation [quoteId=" + quoteId + ", quotationNo=" + quotationNo + ", lineCd=" + lineCd + ", lineCdDesc="
				...
				+ ", contactorName=" + contactorName + ", insuredDesc=" + insuredDesc + ", policyId=" + policyId
				...
				+ ", project=" + project + ", attachmentsList=" + attachmentsList + ", competitiosList="
				+ competitiosList + ", otherRatesList=" + otherRatesList + ", optionsList=" + optionsList + ", alop="
				+ alop + "]";
	}
