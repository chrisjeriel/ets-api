...
public class AcseAcctEntriesExt {
	...
	public String toString() {
		return "AcseAcctEntriesExt [extractId=" + extractId + ", tranId=" + tranId + ", tranDate=" + tranDate
				...
				+ slTypeParam + ", slTypeParamName=" + slTypeParamName + ", orTag=" + orTag + ", cvTag=" + cvTag
