...
public class POLR044SB {
	...
	public BigDecimal getSiRange() {
		return siRange;
	}
	public void setSiRange(BigDecimal siRange) {
	...
	public String toString() {
		return "POLR044SB [extractUser=" + extractUser + ", extractDate=" + extractDate + ", currencyCd=" + currencyCd
