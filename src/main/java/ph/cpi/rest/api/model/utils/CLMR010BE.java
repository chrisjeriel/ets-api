...
public class CLMR010BE {
	...
	public String getClmCoRefNo() {
		return clmCoRefNo;
	}
	public void setClmCoRefNo(String clmCoRefNo) {
		this.clmCoRefNo = clmCoRefNo;
	}
	...
	public String toString() {
		return "CLMR010BE [dateFromTo=" + dateFromTo + ", extractUser=" + extractUser + ", extractDate=" + extractDate
				+ ", currencyCd=" + currencyCd + ", lineCd=" + lineCd + ", claimId=" + claimId + ", claimNo=" + claimNo
				+ ", histType=" + histType + ", histTypeDesc=" + histTypeDesc + ", bookingMth=" + bookingMth
				+ ", bookingYear=" + bookingYear + ", adjId=" + adjId + ", adjRefNo=" + adjRefNo + ", adjName="
				+ adjName + ", cedingId=" + cedingId + ", cedingName=" + cedingName + ", policyId=" + policyId
				+ ", policyNo=" + policyNo + ", polCoRefNo=" + polCoRefNo + ", insuredClm=" + insuredClm
				+ ", insuredDesc=" + insuredDesc + ", approvedAmt=" + approvedAmt + ", lossCd=" + lossCd + ", lossAbbr="
