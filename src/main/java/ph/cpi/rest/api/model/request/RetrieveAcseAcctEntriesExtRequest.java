...
public class RetrieveAcseAcctEntriesExtRequest {
	...
	public String toString() {
		return "RetrieveAcseAcctEntriesExtRequest [entryType=" + entryType + ", periodType=" + periodType
				+ ", periodFrom=" + periodFrom + ", periodTo=" + periodTo + ", acctParam=" + acctParam
				+ ", slTypeParam=" + slTypeParam + ", orTag=" + orTag + ", cvTag=" + cvTag + ", jvTag=" + jvTag
