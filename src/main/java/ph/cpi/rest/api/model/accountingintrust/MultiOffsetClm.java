...
public class MultiOffsetClm {
	...
	public String toString() {
		return "MultiOffsetClm [tranId=" + tranId + ", claimId=" + claimId + ", claimNo=" + claimNo + ", histCategory="
				...
				+ histTypeDesc + ", exGratia=" + exGratia + ", reserveAmt=" + reserveAmt + ", insuredDesc="
				+ insuredDesc + ", projId=" + projId + ", histNo=" + histNo + ", paymentFor=" + paymentFor + ", currCd="
