...
public class RetrieveMtnCedingCompanyListingResponse extends Response{
	...
	public String toString() {
		return "RetrieveMtnCedingCompanyListingResponse [cedingcompany=" + cedingcompany + ", paginationResponse="
