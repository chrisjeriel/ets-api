...
public class POLR044G {
	...
	private String renThisMmQty;
	private String renThisMmPrem;
	private String renCumuQty;
	private String renCumuPrem;
	private String newThisMmQty;
	private String newThisMmPrem;
	private String newCumuQty;
	private String newCumuPrem;
	private String currencyCd;
	private String totThisMmQty;
	...
	public String getRenThisMmQty() {
		return renThisMmQty;
	}
	public void setRenThisMmQty(String renThisMmQty) {
	...
	public String getRenCumuQty() {
		return renCumuQty;
	}
	public void setRenCumuQty(String renCumuQty) {
	...
	public String getNewThisMmQty() {
		return newThisMmQty;
	}
	public void setNewThisMmQty(String newThisMmQty) {
	...
	public String getNewCumuQty() {
		return newCumuQty;
	}
	public void setNewCumuQty(String newCumuQty) {
	...
	public String getTotThisMmQty() {
		return totThisMmQty;
	}
	public void setTotThisMmQty(String totThisMmQty) {
	...
	public String getTotCumuQty() {
		return totCumuQty;
	}
	public void setTotCumuQty(String totCumuQty) {
