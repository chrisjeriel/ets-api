...
public class DistPolInstTreaty {
	...
	public String toString() {
		return "DistPolInstTreaty [treatyId=" + treatyId + ", treatyAbbr=" + treatyAbbr + ", section=" + section
				+ ", trtyCedId=" + trtyCedId + ", trtyCedName=" + trtyCedName + ", premAmt=" + premAmt + ", commRt="
				+ commRt + ", commAmt=" + commAmt + ", vatRiComm=" + vatRiComm + ", netDue=" + netDue + ", createUser="
