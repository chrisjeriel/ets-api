...
public class POLR044SA {
	...
	public BigDecimal getSiTotalRet() {
		return siTotalRet;
	}
	public void setSiTotalRet(BigDecimal siTotalRet) {
		this.siTotalRet = siTotalRet;
	}
	...
	public String toString() {
		return "POLR044SA [extractUser=" + extractUser + ", extractDate=" + extractDate + ", currencyCd=" + currencyCd
				+ ", lineCd=" + lineCd + ", policyId=" + policyId + ", policyNo=" + policyNo + ", tsiAmt=" + tsiAmt
				+ ", cedingId=" + cedingId + ", cedingName=" + cedingName + ", siQuotaRet1=" + siQuotaRet1
				+ ", siQuotaRet2=" + siQuotaRet2 + ", siTotalRet=" + siTotalRet + ", siRange=" + siRange
