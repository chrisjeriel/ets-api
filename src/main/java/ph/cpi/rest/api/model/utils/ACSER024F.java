...
public class ACSER024F {
	...
	public String toString() {
		return "ACSER024F [eomMm=" + eomMm + ", eomYear=" + eomYear + ", currCd=" + currCd + ", currRt=" + currRt
				...
				+ glAcctSub1 + ", glAcctSub2=" + glAcctSub2 + ", glAcctSub3=" + glAcctSub3 + "]";
	}
}
