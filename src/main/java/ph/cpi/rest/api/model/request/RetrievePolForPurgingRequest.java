...
public class RetrievePolForPurgingRequest {
	...
	public String toString() {
		return "RetrievePolForPurgingRequest [policyId=" + policyId + ", polLineCd=" + polLineCd + ", polYear="
				...
				+ extractUser + ", paginationRequest=" + paginationRequest + ", sortRequest=" + sortRequest + "]";
	}
