...
public class EditInTrustAccountingEntriesRequest {
	private String tranId;
	private String histNo;
	private String reason;
	private String createUser;
	private String updateUser;
	private List<EdtAcctEnt> saveList;
	private List<EdtAcctEnt> delList;
	...
	public List<EdtAcctEnt> getSaveList() {
		return saveList;
	}
	public void setSaveList(List<EdtAcctEnt> saveList) {
		this.saveList = saveList;
	}
	public List<EdtAcctEnt> getDelList() {
		return delList;
	}
	public void setDelList(List<EdtAcctEnt> delList) {
		this.delList = delList;
	}
	@Override
	public String toString() {
		return "EditInTrustAccountingEntriesRequest [tranId=" + tranId + ", histNo=" + histNo + ", reason=" + reason
...
class EdtAcctEnt{
	...
	@Override
	public String toString() {
		return "EdtAcctEnt [tranId=" + tranId + ", entryId=" + entryId + ", glAcctId=" + glAcctId + ", slTypeCd="
