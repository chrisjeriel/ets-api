...
public class ACSER007 {
	...
	public String toString() {
		return "ACSER007 [reportId=" + reportId + ", reportName=" + reportName + ", entryType=" + entryType
				+ ", periodType=" + periodType + ", periodFrom=" + periodFrom + ", periodTo=" + periodTo
				+ ", acctParam=" + acctParam + ", slTypeParam=" + slTypeParam + ", orTag=" + orTag + ", cvTag=" + cvTag
				+ ", jvTag=" + jvTag + ", closeTranTag=" + closeTranTag + ", appendTag=" + appendTag + ", extractUser="
				+ extractUser + ", extractDate=" + extractDate + ", currCdParam=" + currCdParam + ", forceExtract="
				+ forceExtract + "]";
	}
