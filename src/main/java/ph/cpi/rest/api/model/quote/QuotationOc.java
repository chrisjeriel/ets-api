...
public class QuotationOc {
	...
	public String toString() {
		return "QuotationOC [quoteIdOc=" + quoteIdOc + ", openQuotationNo=" + openQuotationNo + ", lineCd=" + lineCd
				+ ", lineCdDesc=" + lineCdDesc + ", year=" + year + ", seqNo=" + seqNo + ", sevNo=" + sevNo
				...
				+ reqMode + ", currencyCd=" + currencyCd + ", currencyRt=" + currencyRt + ", govtTag=" + govtTag
				...
				+ ", updateDate=" + updateDate + ", projectOc=" + projectOc + ", attachment=" + attachment + "]";
	}
