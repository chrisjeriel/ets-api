...
public class SaveQuoteGeneralInfoRequest {
	...
	public String getQuoteRevNo() {
		return quoteRevNo;
	}
	public void setQuoteRevNo(String quoteRevNo) {
	...
	public String toString() {
		return "SaveQuoteGeneralInfoRequest [quoteId=" + quoteId + ", lineCd=" + lineCd + ", quoteYear=" + quoteYear
