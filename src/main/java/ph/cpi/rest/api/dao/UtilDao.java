...
public interface UtilDao {
	...
	public List<ACSER060A> retrieveAcseR060a(final HashMap<String, Object> params ) throws SQLException;
	public List<ACSER060B> retrieveAcseR060b(final HashMap<String, Object> params ) throws SQLException;
	public List<ACSER060C> retrieveAcseR060c(final HashMap<String, Object> params ) throws SQLException;
	public List<ACSER060D> retrieveAcseR060d(final HashMap<String, Object> params ) throws SQLException;
	public List<ACITR066J> retrieveAcitR066j(final HashMap<String, Object> params ) throws SQLException;
	public List<POLR044SB> retrievePolR044sb(final HashMap<String, Object> params ) throws SQLException;
	public List<POLR044SC> retrievePolR044sc(final HashMap<String, Object> params ) throws SQLException;
	public List<POLR052L> retrievePolR052l(final HashMap<String, Object> params ) throws SQLException;
	public List<POLR052M> retrievePolR052m(final HashMap<String, Object> params ) throws SQLException;
	public List<CLMR010ZBO> retrieveClmR010zbo(final HashMap<String, Object> params ) throws SQLException;
	...
	public List<CLMR052C> retrieveClmR052c(final HashMap<String, Object> params ) throws SQLException;
	public List<CLMR052CA> retrieveClmR052ca(final HashMap<String, Object> params ) throws SQLException;
	public List<CLMR052D> retrieveClmR052d(final HashMap<String, Object> params ) throws SQLException;
	public List<CLMR052DA> retrieveClmR052da(final HashMap<String, Object> params ) throws SQLException;
	public List<POLR044JB> retrievePolR044jb(final HashMap<String, Object> params ) throws SQLException;
	public List<POLR044KB> retrievePolR044kb(final HashMap<String, Object> params ) throws SQLException;
}
