...
public class UtilDaoImpl implements UtilDao{
	...
	public Integer extractReport(HashMap<String, Object> params) throws SQLException {
        ...
        } else if ("ACITR061H".equalsIgnoreCase((String) params.get("reportId"))) {
            extractionMethod = "extractACITR061H";
        } else if ("ACITR061I".equalsIgnoreCase((String) params.get("reportId"))) {
            extractionMethod = "extractACITR061I";
        } else  {
